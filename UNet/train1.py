...
def main() :
    ...
    parser.add_argument("--model-name", type = str, default = "DeepLabV3Plus_timm-regnetx_064")
    ...
    model = smp.DeepLabV3Plus("timm-regnetx_064", classes = args.num_class).to(device)
    #model = smp.DeepLabV3Plus("resnet152", classes = args.num_class).to(device)
